...
Deno.test({
    name: "eq1",
    fn: () => {
        assert(result["eq1"] == "eqvalue1", "Key `eq1` should be `eqvalue1`");
    },
});
...
Deno.test({
    name: "eq2",
    fn: () => {
        assert(result["eq2"] == "eqvalue2", "Key `eq2` should be `eqvalue2`");
    },
});
...
Deno.test({
    name: "eq3",
    fn: () => {
        assert(result["eq3"] == "eqvalue3", "Key `eq3` should be `eqvalue3`");
    },
});
...
Deno.test({
    name: "eq4",
    fn: () => {
        assert(result["eq4"] == "eqvalue4", "Key `eq4` should be `eqvalue4`");
    },
});
...
Deno.test({
    name: "ml",
    fn: () => {
        assert(result["mlalpha"] == "abcd", "Key `mlalpha` should be `abcd`");
    },
});
